...
public:
    ...
    std::vector<std::vector<unsigned>> intersection_street_segments, adjacent_intersections;
    ...
    std::unordered_map<std::string, std::vector<unsigned>>NameToStreetID, POI_name_to_IDs;
    ...
    std::vector<unsigned> pathIDs, POIID_to_intersectionID;
