...
public:
    ...
    Display *display;
    int screen_num, popup_lines;
    Window toplevel, menu, textarea, popup;
    GC gc_normal, gc_xor, gc_menus, current_gc;
    XftDraw *toplevel_draw, *menu_draw, *textarea_draw, *popuparea_draw;
    XftColor xft_menutextcolor;
    XftColor xft_currentcolor;
    XftColor xft_darkGrey;
